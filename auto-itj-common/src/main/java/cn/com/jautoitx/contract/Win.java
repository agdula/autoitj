 ...
 * @version: 1.0
 */
public interface Win<T extends WinRef> {
	 ...
	 *         returns null if no window matches the criteria.
	 */
	List<String> getClassList_(T hWnd);
	 ...
	 *         returns null if windows is not found or window is minimized.
	 */
	Integer getClientHeight(T hWnd);
	 ...
	 *         window. Returns null if the window is not found.
	 */
	List<WinState> getState_(T hWnd);
	 ...
	 *         found.
	 */
	boolean menuSelectItem(T hWnd, String item1);
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	boolean move(T hWnd, int x, int y);
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	boolean setOnTop(T hWnd, boolean on);
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	boolean setState(T hWnd, WinSetState winState);
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	boolean setState(T hWnd, int flags);
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	boolean setTitle(T hWnd, String newTitle);
	 ...
	 * @return Returns true if success, returns false if failure.
	 */
	boolean setTrans(T hWnd, int transparency);
	 ...
	 * @return Returns true if success, returns false if timeout occurred.
	 */
	boolean wait(T hWnd, Integer timeout);
	 ...
	 * @return Returns true if success, returns false if timeout occurred.
	 */
	boolean waitActive(T hWnd, Integer timeout);
	 ...
	 * @return Returns true if success, returns false if timeout occurred.
	 */
	boolean waitClose(T hWnd, Integer timeout);
	 ...
	 * @return Returns false if the timeout occurred, otherwise returns true.
	 */
	boolean waitNotActive(T hWnd, Integer timeout);
