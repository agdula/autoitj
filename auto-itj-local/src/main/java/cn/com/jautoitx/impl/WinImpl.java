...
import static cn.com.jautoitx.util.AutoItUtils.hwndToHandle;

public final class WinImpl implements Win<WinRefEx> {
	 ...
	 * @return Returns true if window is activated, otherwise returns false.
	 */
	public boolean activate(final WinRefEx hWnd) {
	 ...
	 * @return Returns 1 if success, returns 0 if window is not found.
	 */
	public boolean close(final WinRefEx hWnd) {
	 ...
	 *         WinExist will return true even if a window is hidden.
	 */
	public boolean exists(final WinRefEx hWnd) {
	 ...
	 *         returns null if windows is not found or window is minimized.
	 */
	public Integer getClientHeight(final WinRefEx hWnd) {
	 ...
	 *         null if windows is not found or window is minimized.
	 */
	public int[] getClientSize(final WinRefEx hWnd) {
	 ...
	 *         null if windows is not found or window is minimized.
	 */
	public Integer getClientWidth(final WinRefEx hWnd) {
	...
	public WinRefEx getHandle_(final String title, final String text) {
		WinDef.HWND hwnd = AutoItXImpl.autoItX.AU3_WinGetHandle(AutoItUtils.stringToWString(AutoItUtils.defaultString(title)),
				AutoItUtils.stringToWString(text));
		return new WinRefEx(hwndToHandle(hwnd));
	}
	 ...
	 *         windows is not found or window is minimized.
	 */
	public int[] getPos(final WinRefEx hWnd) {
	 ...
	 *         windows is not found or window is minimized.
	 */
	public Integer getPosX(final WinRefEx hWnd) {
	 ...
	 *         windows is not found or window is minimize.
	 */
	public Integer getPosY(final WinRefEx hWnd) {
	 ...
	 *         windows is not found or window is minimized.
	 */
	public Integer getHeight(final WinRefEx hWnd) {
	 ...
	 *         windows is not found or window is minimized.
	 */
	public Integer getWidth(final WinRefEx hWnd) {
	 ...
	 * @return Returns the Process ID (PID) if success, return null if failed.
	 */
	public Integer getProcess(final WinRefEx hWnd) {
	 ...
	 *         windows is not found or window is minimized.
	 */
	public int[] getSize(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if the window is maximized, otherwise returns false.
	 */
	public boolean maximized(final WinRefEx hWnd) {
	 ...
	 *         Returns null if the window is not found.
	 */
	public Integer getState(final WinRefEx hWnd) {
	 ...
	 *         window. Returns null if the window is not found.
	 */
	public List<WinState> getState_(final WinRefEx hWnd) {
	 ...
	 * @return Returns a string containing the window text read.
	 */
	public String getText(final WinRefEx hWnd) {
	 ...
	 *         returns null if no title match.
	 */
	public String getTitle(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean kill(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean move(final WinRefEx hWnd, final int x, final int y) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean show(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean hide(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean minimize(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean maximize(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean restore(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean setState(final WinRefEx hWnd, final WinSetState winState) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean setState(final WinRefEx hWnd, final int flags) {
	 ...
	 * @return Returns true if success, returns false if window is not found.
	 */
	public boolean setTitle(final WinRefEx hWnd, final String newTitle) {
	 ...
	 * @return Returns true if success, returns false if failure.
	 */
	public boolean setTrans(final WinRefEx hWnd, final int transparency) {
	 ...
	 * @return Returns true if success, returns false if timeout occurred.
	 */
	public boolean waitActive(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if timeout occurred.
	 */
	public boolean waitClose(final WinRefEx hWnd) {
	 ...
	 * @return Returns true if success, returns false if timeout occurred.
	 */
	public boolean waitClose(final WinRefEx hWnd, final Integer timeout) {
	 ...
	 * @return Returns false if the timeout occurred, otherwise returns true.
	 */
	public boolean waitNotActive(final WinRefEx hWnd) {
	 ...
	 * @return Returns false if the timeout occurred, otherwise returns true.
	 */
	public boolean waitNotActive(final WinRefEx hWnd, final Integer timeout) {
		return (hWnd == null) ? false
