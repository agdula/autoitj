...
public class ListViewTest extends BaseTest {
	...
	public void deSelect() {
		...
		Control.setText(HASH_MY_FILES_ADD_FILES_TITLE, "Edit1", new File(
				"src/test/resources/HashMyFiles.exe").getAbsolutePath());
		Keyboard.send("{ENTER}");
		sleep(1000);
		assertEquals(1,
				ListView.getItemCount(HASH_MY_FILES_TITLE, "SysListView321"));
		...
		sleep(500);
		Control.setText(HASH_MY_FILES_ADD_FILES_TITLE, "Edit1", new File(
				"src/test/resources/iniDelete.tmp").getAbsolutePath());
		Keyboard.send("{ENTER}");
		sleep(1000);
		assertEquals(2,
				ListView.getItemCount(HASH_MY_FILES_TITLE, "SysListView321"));
	...
	public void findItem() {
		...
		sleep(500);
		Control.setText(HASH_MY_FILES_ADD_FILES_TITLE, "Edit1", new File(
				"src/test/resources/你好.txt").getAbsolutePath());
		Keyboard.send("{ENTER}");
		sleep(1000);
		assertEquals(2,
				ListView.getItemCount(HASH_MY_FILES_TITLE, "SysListView321"));
	...
	public void tearDown() {
		File file = new File("src/test/resources/HashMyFiles.cfg");
		if (file.exists()) {
			file.delete();
		}
	}
